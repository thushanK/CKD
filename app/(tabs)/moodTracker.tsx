...
export default function Tab() {
	...
	const [intakeByDate, setIntakeByDate] = useState<{ [key: string]: number }>({});
	...
	const markedDates = Object.keys(intakeByDate).reduce((acc, date) => {
		acc[date] = {
			marked: true,
			dotColor: "#2196F3",
	...
	return (
		<SafeAreaView style={styles.container}>
			...
			<Calendar markedDates={markedDates} style={{ marginBottom: 20 }} />
